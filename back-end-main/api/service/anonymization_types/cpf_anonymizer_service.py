...
def anonymization_cpf(seed: int) -> str:
    """
    This function generates new cpf.
    ...
    # Create cpf generator and define data language
    faker = Faker(["pt_BR"])
...
def anonymization_data(
    ...
    for number_row in range(len(rows_to_anonymize)):
        ...
        # Generate new email
        new_email = anonymization_cpf(seed=primary_key_value)
